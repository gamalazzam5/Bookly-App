...
class CustomButton extends StatelessWidget {
  const CustomButton({super.key,  this.topLeft=16,  this.bottomLeft=16,  this.topRight=0,  this.bottomRight=0,  this.backgroundColor= Colors.white,  this.textColor= Colors.black, required this.text,  this.fontSize });
